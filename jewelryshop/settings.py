...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_preprocessors.wishlist_menu',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aiswell673@gmail.com'
EMAIL_HOST_PASSWORD = 'dvjixhdtsxyfckfe'

RAZORPAY_KEY_ID = 'rzp_test_PMplvBaaUKzdl6'
RAZORPAY_KEY_SECRET = 'TLFPGsKKxACsZqp5PQDLgkfg'
