...
class Order(models.Model):
    user = models.ForeignKey(User, verbose_name="User", on_delete=models.CASCADE)
    address = models.CharField(verbose_name="Shipping Address", max_length=255)
    product = models.ForeignKey(Product, verbose_name="Product", on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(verbose_name="Quantity")
    payment_id = models.CharField(max_length=255, verbose_name="Payment ID", default="COD")
    ...
    tracking_link = models.CharField(max_length=200, verbose_name="Tracking Link", default="#")
